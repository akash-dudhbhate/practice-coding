#!/usr/bin/env python3
"""
Lesson 02 — State & useState — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="Counter", required=("useState", "setCount", "onClick")),
    "easy/p02": make_check(component="Toggle", required=("useState", "onClick"), any_of=(("? ", "isOn"),)),
    "easy/p03": make_check(component="TextInput", required=("useState", "onChange", "e.target.value", "<input")),
    "medium/p01": make_check(component="TodoList", required=("useState", "onChange", "map", "filter", "key=")),
    "medium/p02": make_check(component="Counter", required=("useState", "prev", "Reset"), min_occurrences={"<button": 3}),
    "medium/p03": make_check(component="Form", required=("useState", "e.target.name", "...form", "onChange")),
    "hard/p01": make_check(component="ShoppingCart", required=("useState", "map", "filter", "reduce", "key=")),
    "hard/p02": make_check(component="MultiStepForm", required=("useState", "step", "Next", "Back", "e.target.name")),
    "hard/p03": make_check(component="Accordion", required=("useState", "sections", "map", "openIndex")),
}
