#!/usr/bin/env python3
"""
Lesson 05 — Lists & Keys — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="FruitList", required=("map", "key=", "<li")),
    "easy/p02": make_check(component="NumberList", required=("map", "key=", "<li")),
    "easy/p03": make_check(component="UserCards", required=("map", "key=", "email")),
    "medium/p01": make_check(component="DynamicTodo", required=("useState", "map", "filter", "key=")),
    "medium/p02": make_check(component="SearchableList", required=("useState", "filter", "map", "includes")),
    "medium/p03": make_check(component="SortableList", required=("useState", "sort", "map", "key=")),
    "hard/p01": make_check(component="NestedList", required=("map", "key=", "items"), min_occurrences={"map(": 2}),
    "hard/p02": make_check(component="TodoWithComponents", required=("useState", "TodoItem", "key=", "map")),
    "hard/p03": make_check(component="ReorderableList", required=("useState", "map", "key=", "item.id", "setItems")),
}
