#!/usr/bin/env python3
"""
Lesson 11 — Context API — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="ThemedComponent", required=("createContext", "useContext", "ThemeContext", "Provider", "className")),
    "easy/p02": make_check(component="DeepChild", required=("createContext", "useContext", "UserContext", "Provider", "name", "role")),
    "easy/p03": make_check(component="Greeting", required=("createContext", "useContext", "useState", "LangContext", "Provider", "setLang", "onClick")),
    "medium/p01": make_check(component="ThemeProvider", required=("createContext", "useContext", "useState", "toggleTheme", "useTheme", "children", "Provider")),
    "medium/p02": make_check(component="Component", required=("UserContext", "ThemeContext", "createContext", "useContext", "useState"), min_occurrences={".Provider": 2}),
    "medium/p03": make_check(component="useTheme", required=("useContext", "ThemeContext", "throw new Error", "Provider")),
    "hard/p01": make_check(component="CartProvider", required=("useReducer", "createContext", "useContext", "ADD_ITEM", "REMOVE_ITEM", "CLEAR", "dispatch", "items")),
    "hard/p02": make_check(component="AuthProvider", required=("createContext", "useContext", "useState", "useAuth", "login", "logout", "user")),
    "hard/p03": make_check(component="LanguageProvider", required=("useTranslation", "translations", "setLang", "createContext", "t(", "lang")),
}
