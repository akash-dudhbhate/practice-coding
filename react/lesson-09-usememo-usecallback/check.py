#!/usr/bin/env python3
"""
Lesson 09 — useMemo & useCallback — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="SumDemo", required=("useState", "useMemo", "reduce")),
    "easy/p02": make_check(component="Parent", required=("useState", "useCallback", "memo", "Child")),
    "easy/p03": make_check(component="SortDemo", required=("useState", "useMemo", "sort")),
    "medium/p01": make_check(component="SearchFilter", required=("useState", "useMemo", "filter", "includes")),
    "medium/p02": make_check(component="TodoList", required=("useState", "useCallback", "memo", "TodoItem", "key=")),
    "medium/p03": make_check(component="Dashboard", required=("useState", "useMemo", "useCallback", "memo", "Stats", "Chart", "Table")),
    "hard/p01": make_check(component="DataTable", required=("useState", "useMemo", "filter", "sort", "map", "<table")),
    "hard/p02": make_check(component="MemoForm", required=("useState", "useCallback", "memo", "Field", "setForm")),
    "hard/p03": make_check(component="PerformanceDemo", required=("useState", "useMemo", "Profiler", "onRender", "memoized")),
}
