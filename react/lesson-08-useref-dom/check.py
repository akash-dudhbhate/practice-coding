#!/usr/bin/env python3
"""
Lesson 08 — useRef & DOM Access — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="AutoFocus", required=("useRef", "useEffect", "focus", "ref=")),
    "easy/p02": make_check(component="FocusOnButton", required=("useRef", "onClick", "focus", "ref=")),
    "easy/p03": make_check(component="RefCounter", required=("useRef", ".current", "onClick")),
    "medium/p01": make_check(component="Stopwatch", required=("useState", "useRef", "setInterval", "clearInterval")),
    "medium/p02": make_check(component="PreviousDemo", required=("useRef", "useEffect", "usePrevious", ".current", "useState")),
    "medium/p03": make_check(component="Parent", required=("useRef", "forwardRef", "CustomInput", "focus")),
    "hard/p01": make_check(component="VideoPlayer", required=("useRef", "useState", "<video", "play", "pause", "currentTime")),
    "hard/p02": make_check(component="ScrollToTop", required=("useState", "useEffect", "scroll", "scrollTo", "addEventListener", "removeEventListener")),
    "hard/p03": make_check(component="Parent", required=("useRef", "forwardRef", "useImperativeHandle", "focus", "clear", "validate", "submit")),
}
