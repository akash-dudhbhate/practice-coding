#!/usr/bin/env python3
"""
Lesson 17 — Zustand — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="Counter", required=("create", "useCounterStore", "count", "increment", "decrement", "reset", "set(")),
    "easy/p02": make_check(component="App", required=("create", "useThemeStore", "theme", "toggleTheme", "Header", "Main", "Footer"), min_occurrences={"useThemeStore": 3}),
    "easy/p03": make_check(component="TodoApp", required=("create", "useTodoStore", "todos", "addTodo", "toggleTodo", "deleteTodo", "map", "key=")),
    "medium/p01": make_check(component="LoginForm", required=("create", "useAuthStore", "login", "logout", "loading", "error", "user", "async", "await", "onSubmit")),
    "medium/p02": make_check(component="Cart", required=("create", "useCartStore", "items", "addItem", "removeItem", "updateQuantity", "clearCart", "total", "reduce")),
    "medium/p03": make_check(component="App", required=("create", "persist", "partialize", "setTheme", "setUsername", "usePrefsStore", "name:")),
    "hard/p01": make_check(component="AuthComponent", required=("createAuthSlice", "createCartSlice", "createThemeSlice", "useStore", "login", "addToCart", "toggleTheme")),
    "hard/p02": make_check(component="FileManager", required=("create", "immer", "useFileStore", "addFolder", "addFile", "rename", "push", "splice")),
    "hard/p03": make_check(component="useEcommerceStore", required=("create", "devtools", "persist", "partialize", "addToCart", "removeFromCart", "toggleWishlist", "notifications", "cart", "wishlist", "login", "logout"), jsx=False),
}
