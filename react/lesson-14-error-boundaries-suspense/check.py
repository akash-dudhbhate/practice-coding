#!/usr/bin/env python3
"""
Lesson 14 — Error Boundaries & Suspense — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="ErrorBoundary", required=("class", "extends", "getDerivedStateFromError", "hasError", "this.props.children", "BuggyComponent", "throw")),
    "easy/p02": make_check(component="App", required=("lazy", "Suspense", "fallback", "import(")),
    "easy/p03": make_check(component="ErrorBoundary", required=("class", "extends", "getDerivedStateFromError", "hasError", "throw new Error", "UserCard", "this.props.children")),
    "medium/p01": make_check(component="ErrorBoundary", required=("componentDidCatch", "getDerivedStateFromError", "hasError", "console", "errorInfo", "this.props.children")),
    "medium/p02": make_check(component="ErrorBoundary", required=("getDerivedStateFromError", "reset", "setState", "onClick", "Try Again", "this.props.children")),
    ...
    "hard/p01": make_check(component="ErrorBoundary", required=("componentDidCatch", "this.props.fallback", "reset", "getDerivedStateFromError", "this.props.children")),
    "hard/p02": make_check(component="Dashboard", required=("ErrorBoundary", "getDerivedStateFromError", "reset", "BuggyWidget", "throw"), min_occurrences={"<ErrorBoundary": 3}),
    "hard/p03": make_check(component="App", required=("lazy", "Suspense", "ErrorBoundary", "BrowserRouter", "Route", "import(", "skeleton"), min_occurrences={"lazy(": 5, "<Suspense": 5, "<ErrorBoundary": 5}),
}
