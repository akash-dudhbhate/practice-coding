#!/usr/bin/env python3
"""
Lesson 01 — Components, JSX & Props — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="Greeting", required=("name", "<h1")),
    "easy/p02": make_check(component="Button", required=("label", "color", "<button", "style")),
    "easy/p03": make_check(component="Badge", required=("text", "variant", "<span", "style")),
    "medium/p01": make_check(component="UserCard", required=("name", "email", "role"), min_occurrences={"<UserCard": 3}),
    "medium/p02": make_check(component="PriceList", required=("items", "map", "key=", "<li")),
    "medium/p03": make_check(component="Alert", required=("message", "type", "show"), any_of=(("return null", "!show"),)),
    "hard/p01": make_check(component="Table", required=("columns", "rows", "map", "key=", "<table", "<td")),
    "hard/p02": make_check(component="Comment", required=("comment", "replies", "map"), min_occurrences={"<Comment": 1}),
    "hard/p03": make_check(component="Layout", required=("children", "Header", "Footer", "<main")),
}
