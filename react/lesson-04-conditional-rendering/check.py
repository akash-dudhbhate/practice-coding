#!/usr/bin/env python3
"""
Lesson 04 — Conditional Rendering — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="ShowHide", required=("useState", "onClick", "&&")),
    "easy/p02": make_check(component="LoginLogout", required=("useState", "onClick", "Login", "Logout")),
    "easy/p03": make_check(component="EvenOdd", required=("useState", "% 2", "Even", "Odd", "onChange")),
    "medium/p01": make_check(component="LoadingState", required=("useState", "loading", "Loading", "onClick")),
    "medium/p02": make_check(component="EmptyList", required=("useState", "length", "map", "onClick")),
    "medium/p03": make_check(component="ConditionalButton", required=("useState", "className", "disabled", "onClick")),
    "hard/p01": make_check(component="DataFetcher", required=("useState", "setTimeout", "loading", "error", "success")),
    "hard/p02": make_check(component="StatusDisplay", required=("useState", "loading", "success", "error", "empty")),
    "hard/p03": make_check(component="Dashboard", required=("useState", "admin", "editor", "viewer", "<select")),
}
