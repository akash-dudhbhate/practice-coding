#!/usr/bin/env python3
"""
Lesson 15 — Portals & Modals — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="Modal", required=("createPortal", "document.body", "onClose", "onClick", "useState", "open")),
    "easy/p02": make_check(component="Modal", required=("createPortal", "document.body", "stopPropagation", "onClose", "onClick")),
    "easy/p03": make_check(component="Tooltip", required=("createPortal", "document.body", "getBoundingClientRect", "useRef", "onMouseEnter", "onMouseLeave")),
    "medium/p01": make_check(component="Modal", required=("createPortal", "useEffect", "Escape", "keydown", "addEventListener", "removeEventListener", "overflow", "document.body")),
    "medium/p02": make_check(component="ConfirmDialog", required=("createPortal", "document.body", "onConfirm", "onCancel", "message", "stopPropagation")),
    "medium/p03": make_check(component="SmartTooltip", required=("createPortal", "getBoundingClientRect", "innerWidth", "innerHeight", "useRef", "onMouseEnter")),
    "hard/p01": make_check(component="AccessibleModal", required=("createPortal", "useEffect", "useRef", "Escape", "Tab", 'role="dialog"', "aria-modal", "focus", "querySelectorAll", "activeElement")),
    "hard/p02": make_check(component="AnimatedModal", required=("createPortal", "setTimeout", "transition", "opacity", "transform", "useEffect", "visible")),
    "hard/p03": make_check(component="ToastContainer", required=("createPortal", "document.body", "toast", "setTimeout", "map", "key=", "listeners", "success", "error")),
}
