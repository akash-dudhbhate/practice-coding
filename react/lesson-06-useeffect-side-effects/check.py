#!/usr/bin/env python3
"""
Lesson 06 — useEffect & Side Effects — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="DocTitleCounter", required=("useState", "useEffect", "document.title", "onClick")),
    "easy/p02": make_check(component="MountMessage", required=("useEffect", "console.log", "[]")),
    "easy/p03": make_check(component="WindowWidth", required=("useState", "useEffect", "addEventListener", "removeEventListener", "resize")),
    "medium/p01": make_check(component="FetchUser", required=("useState", "useEffect", "fetch", "loading")),
    "medium/p02": make_check(component="Countdown", required=("useState", "useEffect", "setInterval", "clearInterval")),
    "medium/p03": make_check(component="UserProfile", required=("useState", "useEffect", "fetch", "userId", "loading")),
    "hard/p01": make_check(component="LiveSearch", required=("useState", "useEffect", "setTimeout", "clearTimeout", "fetch")),
    "hard/p02": make_check(component="MouseTracker", required=("useState", "useEffect", "mousemove", "addEventListener", "removeEventListener")),
    "hard/p03": make_check(component="Chat", required=("useState", "useEffect", "roomId", "fetch", "document.title"), min_occurrences={"useEffect(": 3}),
}
