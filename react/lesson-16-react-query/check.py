#!/usr/bin/env python3
"""
Lesson 16 — React Query — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="UserList", required=("QueryClient", "QueryClientProvider", "useQuery", "queryKey", "queryFn", "isLoading", "map", "key=")),
    "easy/p02": make_check(component="UserWithErrors", required=("useQuery", "queryKey", "queryFn", "isLoading", "error", "refetch", "throw new Error")),
    "easy/p03": make_check(component="UserById", required=("useQuery", "queryKey", "userId", "useState", "setUserId", "queryFn"), min_occurrences={"<button": 3}),
    "medium/p01": make_check(component="ProductList", required=("useQuery", "useMutation", "useQueryClient", "invalidateQueries", "mutationFn", "onSuccess", "mutate", "isPending")),
    "medium/p02": make_check(component="TodoApp", required=("useQuery", "useQueryClient", "invalidateQueries", "addMutation", "toggleMutation", "deleteMutation", "mutate"), min_occurrences={"useMutation": 3}),
    "medium/p03": make_check(component="PaginatedList", required=("useQuery", "keepPreviousData", "placeholderData", "queryKey", "page", "isFetching", "setPage")),
    "hard/p01": make_check(component="SearchUsers", required=("useDebounce", "useQuery", "debounced", "setTimeout", "clearTimeout", "enabled", "queryKey", "isFetching")),
    "hard/p02": make_check(component="OptimisticTodos", required=("useMutation", "onMutate", "onError", "onSettled", "setQueryData", "getQueryData", "cancelQueries", "invalidateQueries", "simulateError")),
    "hard/p03": make_check(component="InfiniteFeed", required=("useInfiniteQuery", "fetchNextPage", "hasNextPage", "isFetchingNextPage", "getNextPageParam", "initialPageParam", "data.pages")),
}
