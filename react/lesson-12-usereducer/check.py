#!/usr/bin/env python3
"""
Lesson 12 — useReducer — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="Counter", required=("useReducer", "dispatch", "increment", "decrement", "reset", "onClick")),
    "easy/p02": make_check(component="Toggle", required=("useReducer", "dispatch", "toggle", "onClick"), any_of=(("isOn", "ON"),)),
    "easy/p03": make_check(component="TextInput", required=("useReducer", "dispatch", "SET_TEXT", "payload", "onChange", "<input")),
    "medium/p01": make_check(component="Cart", required=("useReducer", "dispatch", "ADD_ITEM", "REMOVE_ITEM", "UPDATE_QTY", "CLEAR", "reduce", "map", "key=")),
    "medium/p02": make_check(component="MultiStepForm", required=("useReducer", "dispatch", "NEXT_STEP", "PREV_STEP", "UPDATE_FIELD", "SET_ERROR", "formData", "step")),
    "medium/p03": make_check(component="TodoProvider", required=("useReducer", "createContext", "useContext", "ADD", "TOGGLE", "DELETE", "CLEAR_COMPLETED", "Provider")),
    "hard/p01": make_check(component="TicTacToe", required=("useReducer", "dispatch", "MAKE_MOVE", "RESET", "board", "currentPlayer", "winner", "checkWinner")),
    "hard/p02": make_check(component="useFetchReducer", required=("useReducer", "useEffect", "useRef", "dispatch", "FETCH_START", "FETCH_SUCCESS", "FETCH_ERROR", "loading", "error")),
    "hard/p03": make_check(component="AppProvider", required=("useReducer", "createContext", "useContext", "LOGIN", "LOGOUT", "TOGGLE_THEME", "notifications", "Provider")),
}
