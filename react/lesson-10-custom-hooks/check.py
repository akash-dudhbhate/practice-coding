#!/usr/bin/env python3
"""
Lesson 10 — Custom Hooks — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="ToggleDemo", required=("useState", "useToggle", "toggle", "useCallback")),
    "easy/p02": make_check(component="CounterDemo", required=("useState", "useCounter", "increment", "decrement", "reset")),
    "easy/p03": make_check(component="WindowDemo", required=("useState", "useEffect", "useWindowSize", "addEventListener", "removeEventListener")),
    "medium/p01": make_check(component="FetchDemo", required=("useState", "useEffect", "useFetch", "fetch", "loading", "error")),
    "medium/p02": make_check(component="LocalStorageDemo", required=("useState", "useEffect", "useLocalStorage", "localStorage", "JSON")),
    "medium/p03": make_check(component="DebounceSearch", required=("useState", "useEffect", "useDebounce", "setTimeout", "clearTimeout", "fetch")),
    "hard/p01": make_check(component="EventListenerDemo", required=("useState", "useEffect", "useEventListener", "addEventListener", "removeEventListener", "Escape")),
    "hard/p02": make_check(component="RegistrationForm", required=("useState", "useForm", "handleChange", "handleSubmit", "errors", "validate")),
    "hard/p03": make_check(component="Dashboard", required=("useState", "useEffect", "useFetch", "useDebounce", "useLocalStorage", "useUserDashboard")),
}
