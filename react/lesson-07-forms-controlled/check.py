#!/usr/bin/env python3
"""
Lesson 07 — Forms & Controlled Inputs — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="NameInput", required=("useState", "value=", "onChange", "e.target.value")),
    "easy/p02": make_check(component="SubscribeCheckbox", required=("useState", "checkbox", "checked", "e.target.checked")),
    "easy/p03": make_check(component="ColorSelect", required=("useState", "<select", "<option", "onChange")),
    "medium/p01": make_check(component="MultiFieldForm", required=("useState", "e.target.name", "onSubmit", "preventDefault", "<textarea")),
    "medium/p02": make_check(component="SizeSelector", required=("useState", "radio", "checked", "map")),
    "medium/p03": make_check(component="SignupForm", required=("useState", "onSubmit", "preventDefault", "errors", "includes")),
    "hard/p01": make_check(component="RegistrationForm", required=("useState", "validate", "errors", "confirm", "onSubmit", "preventDefault")),
    "hard/p02": make_check(component="ContactForm", required=("useState", "onSubmit", "preventDefault", "setForm", "success", "setTimeout")),
    "hard/p03": make_check(component="DynamicEmails", required=("useState", "map", "filter", "onSubmit", "emails", "key=")),
}
