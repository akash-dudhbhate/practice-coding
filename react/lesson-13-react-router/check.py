#!/usr/bin/env python3
"""
Lesson 13 — React Router — structural checker.
...
CHECKS = {
    "easy/p01": make_check(component="App", required=("BrowserRouter", "Routes", "Route", "Link", "path", "element", "*")),
    "easy/p02": make_check(component="App", required=("NavLink", "isActive", "BrowserRouter", "Routes", "Route"), min_occurrences={"<NavLink": 4}),
    "easy/p03": make_check(component="UserProfile", required=("useParams", "username", ":username", "Link", "Route")),
    "medium/p01": make_check(component="Login", required=("useNavigate", "navigate", "/dashboard", "navigate(-1)", "onSubmit", "Route")),
    "medium/p02": make_check(component="DashboardLayout", required=("Outlet", "Route", "index", "stats", "settings", "Link", "aside")),
    "medium/p03": make_check(component="ProductList", required=("useSearchParams", "params.get", "page", "sort", "setParams", "onClick")),
    "hard/p01": make_check(component="Post", required=("useParams", "slug", "category", "/post/", "Route", "NotFound", "Link", "filter")),
    "hard/p02": make_check(component="Step1", required=("useNavigate", "useLocation", "location.state", "/wizard/step", "navigate", "Link", "Route")),
    "hard/p03": make_check(component="AccountLayout", required=("Outlet", "useParams", "/products/:id", "/checkout", "/account", "index", "Route", "Link")),
}
